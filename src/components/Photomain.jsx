...
const Photomain = () => {
  return (
    <section className="flex flex-col bg-[#131313] w-full md:pr-20 lg:justify-start justify-center px-10 mt-24 mb-10">
      <Scroll />
      ...
      <div className="flex flex-col">
        ...
        <div className="grid lg:grid-cols-3 grid-cols-1 gap-5 mb-5">
          <img src="/d1.jpg" alt="brand flyer" />
          <img src="/d2.png" alt="brand flyer" />
          <img src="/d3.png" alt="brand flyer" />
        </div>
        ...
        <div className="grid lg:grid-cols-3 grid-cols-1 gap-5 mb-5">
          <img src="/d4.png" alt="brand flyer" />
          <img src="/d5.png" alt="brand flyer" />
          <img src="/d6.png" alt="brand flyer" />
          <img src="/d7.png" alt="brand flyer" />
          <img src="/d8.png" alt="brand flyer" />
          <img src="/d9.png" alt="brand flyer" />
          <img src="/d10.png" alt="brand flyer" />
          <img src="/d11.png" alt="brand flyer" />
          <img src="/d12.png" alt="brand flyer" />
          <img src="/d13.png" alt="brand flyer" />
          <img src="/d14.png" alt="brand flyer" />
          <img src="/d15.png" alt="brand flyer" />
        </div>
        ...
        <div className="grid lg:grid-cols-3 grid-cols-1 gap-5 mb-5">
          <img src="/d17.png" alt="brand flyer" />
          <img src="/d18.png" alt="brand flyer" />
          <img src="/d19.png" alt="brand flyer" />
          <img src="/d20.png" alt="brand flyer" />
          <img src="/d21.png" alt="brand flyer" />
          <img src="/d22.png" alt="brand flyer" />
          <img src="/d23.png" alt="brand flyer" />
          <img src="/d24.png" alt="brand flyer" />
          <img src="/d25.png" alt="brand flyer" />
        </div>
