...
const ActConMain = () => {
  return (
    <Layout>
      <section className="flex flex-col bg-[#131313] w-full lg:px-20 lg:justify-start not-first:justify-center px-10">
        <Scroll />
        ...
        <div className="font-glancyr text-[#fff] mb-[20px]">
          ...
          <p className="lg:text-[17px] md:text-[15px] text-[14px] font-light">
            ...
            ACT’s mission of promoting Africa’s culture through sight, sound,
