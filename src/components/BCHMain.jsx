    ...
    <section className="flex flex-col bg-[#131313] w-full lg:px-20 lg:justify-start justify-center px-10 mt-28 mb-10">
      ...
      <div className="font-glancyr text-[#fff] mb-[20px]">
        ...
        <p className="lg:text-[17px] md:text-[15px] text-[14px] font-light">
          ...
          and 3D renders for Bloom and its clients. This brand identity project
          aimed to create a bold, unified visual system that reflects the hub’s
          core message: where creativity meets execution. <br /> <br />
          The logo, a stylized 'b' combined with a pen nib, symbolizes both
          creative thinking and precision. A vibrant gradient palette and clean
          typefaces bring energy and clarity to the brand.
        </p>
      </div>
