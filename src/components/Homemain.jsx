...
const Homemain = () => {
  ...
  return (
    <section className="flex flex-col bg-[#131313] lg:px-20 px-10 pt-5 w-full h-full mt-20 mb-10 font-glancyr">
      <Scroll />
      <p className="text-[#fff] lg:text-[24px] text-[18px] md:text-[22px] font-light lg:mb-10 pr-0 md:pr-10 lg:pr-96 mb-10 tracking-wide font-light">
        ...
        turn their ideas{" "}
        <span className="font-normal italic lg:text-[26px] text-[20px] md:text-[24px]">into designs that work</span>.
      </p>
