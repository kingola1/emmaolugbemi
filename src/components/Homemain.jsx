		...
		<section className="flex flex-col bg-[#131313] lg:px-20 px-10 pt-5 w-full h-full mt-20 mb-10">
			<p className="text-[#fff] lg:text-[26px] text-[20px] md:text-[24px] font-medium lg:mb-4 pr-0 md:pr-10 lg:pr-60 mb-10">
				...
				<span className="font-medium">
					a Creative Designer who loves helping Founders, Start-ups,
					and Brands
				</span>{" "}
				turn their ideas
			...
			<div className="flex flex-col lg:flex-row w-full gap-[20px] h-auto mb-20">
				<div className="flex flex-col gap-10 lg:w-[50%] h-auto">
					<p className="text-[#fff] lg:text-[17px] text-[14px] md:text-[15px] font-normal lg:mb-4 mb-2">
						Here’s more about me. <br /> <br />I am a
						multidisciplinary Graphic Designer with over four years
						of experience crafting visual solutions across branding,
						UI/UX, motion graphics, digital and print design. <br />{" "}
						<br />
						With a foundation in Mechanical Engineering and a sharp
						eye for detail, I blend creative intuition with
						strategic thinking to create designs that are visually
						compelling and purposeful. I’ve led design teams,
						developed brand identities, built design systems, and
						collaborated with cross-functional teams to deliver
						high-performing assets for start-ups, agencies, and
						organizations across various industries. <br /> <br />
						I’m skilled in tools like Adobe Creative Suite, Figma,
						and Blender, and my work spans from digital campaigns to
						product UI, motion design, and corporate communications.{" "}
						<br /> <br /> On a personal level, I love playing
						football, watching anime, and reading mangas, manwhas,
						and webtoons.
					</p>
