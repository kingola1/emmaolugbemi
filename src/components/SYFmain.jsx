      ...
      <section className="flex flex-col bg-[#131313] w-full lg:px-20 lg:justify-start justify-center px-10">
        ...
        <div className="font-glancyr text-[#fff] mb-[20px]">
          ...
          <p className="lg:text-[17px] md:text-[15px] text-[14px] font-light">
            ...
            that focuses on social impact within Africa with a focus on
            equipping talented youth with the economical means to grow
            leadership skills by way of scholarships, mentorships, and skill
            acquisition at summer camps.
            <br /> <br />
            This project involved the redesign of The Special Youth Leadership
            Foundation’s logo and website for a more modern and professional
            look and feel.
          </p>
        </div>
