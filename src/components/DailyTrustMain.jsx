...
const DailyTrustMain = () => {
  return (
    <Layout>
      <section className="flex flex-col bg-[#131313] w-full lg:px-20 lg:justify-start justify-center mb-10 px-10">
        <Scroll />
        ...
        <div className="font-glancyr text-[#fff] mb-[20px]">
          ...
          <p className="lg:text-[17px] md:text-[15px] text-[14px] font-light">
            ...
            which is a privately held newspaper publishing company that
            publishes the English-language Daily Trust, Weekly Trust, Sunday
            Trust and the Hausa-language Aminiya newspapers, as well as a new
            pan-African magazine, Kilimanjaro. It is one of the leading media
